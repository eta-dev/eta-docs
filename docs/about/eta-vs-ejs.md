...
- Eta compiles and renders templates **_much_ faster than EJS**. Check out these benchmarks: https://raw.githack.com/eta-dev/eta/master/browser-tests/benchmark.html

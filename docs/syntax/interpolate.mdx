...
Since Eta templates parse into JavaScript, you can write a reference using dot notation: `<p>User's last name: <%= it.user.lastName %>` or bracket notation: `<p>User's last name: <%= it.user['lastName'] %>`.
